...
export class TestContainers {
  ...
  async stop() {
    ...
    const stopPromises = Object.values(this.containers)
  ...
  async #startMongo() {
    ...
    return {
      container,
      env: {
        MONGO_URI: `mongodb://${host}:${port}/fg-cw-backend?replicaSet=mongoRepl&directConnection=true`,
  ...
  async #startEntra() {
    ...
    return {
      ...
      env: {
        ...
        OIDC_SIGN_TOKEN_ENDPOINT: `http://${host}:${port}/sign`,

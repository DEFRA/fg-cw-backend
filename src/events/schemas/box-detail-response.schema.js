...
// `message` is truncated to 512 characters (events/models/last-error.js).
...
const detailCommon = {
  ...
  // Derived by the same predicate as the list row's labels
  // (events/audit/event-audit.js).
  ...
  // Attempts actually MADE - see ATTEMPT ARITHMETIC in events/models/inbox.js.

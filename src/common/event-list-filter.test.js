...
// There is no TYPE (`kind`) filter: an unknown `kind` is rejected by the box
// query schema before it reaches here, and a `kind` key handed to the builder
// directly is simply ignored.

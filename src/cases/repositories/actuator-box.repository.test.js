...
describe("actuatorBoxQueries findEditableById", () => {
  it("reads what an edit is checked against, bounded and inside the caller's session", async () => {
...
describe("actuatorBoxQueries editPayloadById", () => {
  ...
  it("fences a first edit on the redrivable statuses and a missing, null or 0 counter", async () => {

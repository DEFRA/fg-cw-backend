...
describe("timeline schema", () => {
  ...
  it("must have eventType", () => {
    ...
    expect(
      ...
      '"eventType" must be one of [CASE_CREATED, CASE_ASSIGNED, CASE_UNASSIGNED, TASK_COMPLETED, TASK_UPDATED, PHASE_COMPLETED, STAGE_COMPLETED, CASE_STATUS_CHANGED, NOTE_ADDED]',
    );
  });
